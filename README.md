# React + Tableland (JavaScript) Starter

> A JavaScript template for @tableland + React + wagmi + Rainbowkit projects
...
- `npm run test`: Run tests using `mocha` and Local Tableland, along with a few placeholder integration tests.
